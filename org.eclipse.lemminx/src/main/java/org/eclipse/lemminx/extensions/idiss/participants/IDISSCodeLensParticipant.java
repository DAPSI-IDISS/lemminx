...
/**
 * IDISS CodeLens to show references count between IDISS types references.
 * 
 * @author Angelo ZERR
 *
 */
public class IDISSCodeLensParticipant implements ICodeLensParticipant {
	...
	public void doCodeLens(ICodeLensRequest request, List<CodeLens> lenses, CancelChecker cancelChecker) {
		...
		// IDISS types CodeLens is applicable only for XML Schema file
		...
		IDISSUtils.searchXSOriginAttributes(xmlDocument, (origin, target) -> {

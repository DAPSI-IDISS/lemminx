...
/**
 * IDISS definition which manages the following definition:
 * 
 * <ul>
 ...
 *
 */
public class IDISSDefinitionParticipant extends AbstractDefinitionParticipant {

	@Override
	protected boolean match(DOMDocument document) {
		return DOMUtils.isIDISS(document);
	}
	...
	protected void doFindDefinition(IDefinitionRequest request, List<LocationLink> locations,
		...
		if (bindingType != BindingType.NONE) {
			IDISSUtils.searchXSTargetAttributes(attr, bindingType, true, true, (targetNamespacePrefix, targetAttr) -> {

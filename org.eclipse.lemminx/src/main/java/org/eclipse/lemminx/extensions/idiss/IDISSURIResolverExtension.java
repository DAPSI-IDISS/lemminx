...
/**
 * Resolve the IDISS XML Schema and DTD dependencies.
 *
 */
public class IDISSURIResolverExtension implements URIResolverExtension {
	...
	private static final List<ResourceToDeploy> SCHEMA_URI_2001_RESOURCES = Arrays.asList(
			new ResourceToDeploy("http://www.w3.org/2001/XMLSchema.idiss", "schemas/idiss/XMLSchema.idiss"),
			new ResourceToDeploy("http://www.w3.org/2001/XMLSchema.dtd", "schemas/idiss/XMLSchema.dtd"),
			new ResourceToDeploy("http://www.w3.org/2001/datatypes.dtd", "schemas/idiss/datatypes.dtd"));
	...
	private static final ResourceToDeploy NAMESPACE_URI_1998_RESOURCE = new ResourceToDeploy(
			"https://www.w3.org/2001/xml.idiss", "schemas/idiss/xml.idiss");

	public String getName() {
		return "embedded xml.idiss";
	}

	public IDISSURIResolverExtension(IXMLDocumentProvider documentProvider) {
	...
	public String resolve(String baseLocation, String publicId, String systemId) {
		if (SCHEMA_FOR_SCHEMA_URI_2001.equals(publicId)) {
			try {
				...
				// Returns the patch of "http://www.w3.org/2001/XMLSchema.idiss" file system

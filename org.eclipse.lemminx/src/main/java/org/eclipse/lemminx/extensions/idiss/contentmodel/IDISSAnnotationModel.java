 ...
 *
 */
class IDISSAnnotationModel {

	private final List<String> appInfo;

	private final List<String> documentation;

	private IDISSAnnotationModel() {
	...
	public static List<String> getDocumentation(XSObjectList annotations, String value) {
		...
		for (Object object : annotations) {
			...
			IDISSAnnotationModel annotationModel = IDISSAnnotationModel.load(annotation);
	...
	public static IDISSAnnotationModel load(XSAnnotation annotation) {
		try {
	...
	private static class XSAnnotationHandler extends DefaultHandler {
		...
		private final IDISSAnnotationModel model;

		public XSAnnotationHandler() {
			model = new IDISSAnnotationModel();
		}

		public IDISSAnnotationModel getModel() {
			return model;
		}

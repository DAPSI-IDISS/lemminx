 ...
 */
public class IDISSDocumentation {
	...
	public IDISSDocumentation(XSObjectList annotations, SchemaDocumentationType docStrategy, boolean convertToPlainText) {
		this(annotations, null, docStrategy, convertToPlainText);
	}

	public IDISSDocumentation(XSObjectList annotations, String value, SchemaDocumentationType docStrategy, boolean convertToPlainText) {
		List<String> documentation = Collections.emptyList();
		List<String> appinfo = Collections.emptyList();
		switch(docStrategy) {
			case all: {
				documentation = IDISSAnnotationModel.getDocumentation(annotations, value);
				appinfo = IDISSAnnotationModel.getAppInfo(annotations, value);
				break;
			}
			case documentation: {
				documentation = IDISSAnnotationModel.getDocumentation(annotations, value);
		...
		this.prefix = IDISSAnnotationModel.getPrefix(annotations, value);
	}
	/**

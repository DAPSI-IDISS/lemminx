...
/**
 * IDISS content model provider.
 */
public class CMIDISSContentModelProvider implements ContentModelProvider {
	...
	public CMIDISSContentModelProvider(URIResolverExtensionManager resolverExtensionManager) {
	...
	public CMDocument createCMDocument(String key) {
		...
		if (model != null) {
			...
			return new CMIDISSDocument(model, loader);
		}
		return null;
	}
